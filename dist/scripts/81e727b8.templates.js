Ember.TEMPLATES["_event"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push("\n    </span>\n    <span class=\"meta meta-location\">\n      ");
  hashTypes = {};
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers._triageMustache.call(depth0, "place", {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
  data.buffer.push("\n    </span>\n  </h4>\n  <p>\n    ");
  hashTypes = {};
  hashContexts = {};
...
Ember.TEMPLATES["_person"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers._triageMustache.call(depth0, "name", {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
  data.buffer.push("</a></strong>\n  ");
  hashContexts = {'unescaped': depth0};
  hashTypes = {'unescaped': "STRING"};
  stack1 = helpers._triageMustache.call(depth0, "about", {hash:{
    'unescaped': ("true")
...
Ember.TEMPLATES["_space"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  var buffer = '', stack1, hashContexts, hashTypes, escapeExpression=this.escapeExpression;


  data.buffer.push("<div class=\"space col-md-6\">\n  <a ");
  hashContexts = {'href': depth0};
  hashTypes = {'href': "STRING"};
  data.buffer.push(escapeExpression(helpers.bindAttr.call(depth0, {hash:{
    'href': ("url")
...
Ember.TEMPLATES["_tile"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
...
function program1(depth0,data) {
  ...
  hashContexts = {'unescaped': depth0};
  hashTypes = {'unescaped': "STRING"};
  stack1 = helpers._triageMustache.call(depth0, "embed", {hash:{
    'unescaped': ("true")
  },contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n    <div class=\"caption\">\n      <h3><a ");
...
function program3(depth0,data) {
  ...
  hashTypes = {};
  hashContexts = {};
  stack1 = helpers['if'].call(depth0, "isMedia", {hash:{},inverse:self.program(3, program3, data),fn:self.program(1, program1, data),contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n</div>\n\n");
  return buffer;
...
function program1(depth0,data) {
  ...
  data.buffer.push("Kenya");
  }

function program3(depth0,data) {
  
  
  data.buffer.push("Uganda");
  }

function program5(depth0,data) {
  
  
  data.buffer.push("Rwanda");
  }

function program7(depth0,data) {
  
  
  data.buffer.push("Tanzania");
  }
...
function program11(depth0,data) {
  ...
  stack2 = ((stack1 = helpers.linkTo || depth0.linkTo),stack1 ? stack1.call(depth0, "country", "kenya", options) : helperMissing.call(depth0, "linkTo", "country", "kenya", options));
  ...
  stack2 = ((stack1 = helpers.linkTo || depth0.linkTo),stack1 ? stack1.call(depth0, "country", "uganda", options) : helperMissing.call(depth0, "linkTo", "country", "uganda", options));
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("</li>\n          <li>");
  hashTypes = {};
  hashContexts = {};
  ...
  stack2 = ((stack1 = helpers.linkTo || depth0.linkTo),stack1 ? stack1.call(depth0, "country", "rwanda", options) : helperMissing.call(depth0, "linkTo", "country", "rwanda", options));
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("</li>\n          <li>");
  hashTypes = {};
  hashContexts = {};
  ...
  stack2 = ((stack1 = helpers.linkTo || depth0.linkTo),stack1 ? stack1.call(depth0, "country", "tanzania", options) : helperMissing.call(depth0, "linkTo", "country", "tanzania", options));
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("</li>\n\n          <li>");
  hashContexts = {'class': depth0};
  hashTypes = {'class': "STRING"};
  ...
  stack2 = ((stack1 = helpers.linkTo || depth0.linkTo),stack1 ? stack1.call(depth0, "about-us", options) : helperMissing.call(depth0, "linkTo", "about-us", options));
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("</li>\n          <li>");
  hashContexts = {'class': depth0};
  hashTypes = {'class': "STRING"};
  ...
  stack2 = ((stack1 = helpers.linkTo || depth0.linkTo),stack1 ? stack1.call(depth0, "supporters", options) : helperMissing.call(depth0, "linkTo", "supporters", options));
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
...
function program1(depth0,data) {
  ...
  data.buffer.push(">Schedule on Lanyrd</a>\n          </span>\n        </h2>\n        ");
  hashTypes = {};
  hashContexts = {};
  stack2 = helpers.each.call(depth0, "controller.model.events", {hash:{},inverse:self.noop,fn:self.program(2, program2, data),contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("\n      </section>\n    ");
  return buffer;
  }
function program2(depth0,data) {
  ...
  data.buffer.push(escapeExpression(((stack1 = helpers.partial || depth0.partial),stack1 ? stack1.call(depth0, "event", options) : helperMissing.call(depth0, "partial", "event", options))));
  data.buffer.push("\n         ");
  return buffer;
  }
...
function program4(depth0,data) {
  ...
  data.buffer.push("\n      <section class=\"people row\">\n        <h2>Excited to meet</h2>\n        ");
  hashTypes = {};
  hashContexts = {};
  stack1 = helpers.each.call(depth0, "controller.model.people", {hash:{},inverse:self.noop,fn:self.program(5, program5, data),contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n      </section>\n    ");
  return buffer;
  }
function program5(depth0,data) {
  ...
  hashContexts = {};
  options = {hash:{},contexts:[depth0],types:["STRING"],hashContexts:hashContexts,hashTypes:hashTypes,data:data};
  data.buffer.push(escapeExpression(((stack1 = helpers.partial || depth0.partial),stack1 ? stack1.call(depth0, "person", options) : helperMissing.call(depth0, "partial", "person", options))));
  data.buffer.push("\n        ");
  return buffer;
  }
...
function program7(depth0,data) {
  ...
  var buffer = '', stack1, hashTypes, hashContexts;
  data.buffer.push("\n  <section class=\"row\">\n    <h2>Places / Hubs / Communities</h2>\n    ");
  hashTypes = {};
  hashContexts = {};
  stack1 = helpers.each.call(depth0, "controller.model.spaces", {hash:{},inverse:self.noop,fn:self.program(8, program8, data),contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n  </section>\n");
  return buffer;
  }
function program8(depth0,data) {
  ...
  hashContexts = {};
  options = {hash:{},contexts:[depth0],types:["STRING"],hashContexts:hashContexts,hashTypes:hashTypes,data:data};
  data.buffer.push(escapeExpression(((stack1 = helpers.partial || depth0.partial),stack1 ? stack1.call(depth0, "space", options) : helperMissing.call(depth0, "partial", "space", options))));
  data.buffer.push("\n    ");
  return buffer;
  }
...
function program10(depth0,data) {
  ...
  hashTypes = {};
  hashContexts = {};
  stack1 = helpers.each.call(depth0, "controller.model.tiles", {hash:{},inverse:self.noop,fn:self.program(11, program11, data),contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n    </div>\n  </section>\n");
  return buffer;
  }
function program11(depth0,data) {
  ...
  hashTypes = {};
  hashContexts = {};
  stack2 = helpers['if'].call(depth0, "controller.model.events", {hash:{},inverse:self.noop,fn:self.program(1, program1, data),contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("\n\n    ");
  hashTypes = {};
  hashContexts = {};
  stack2 = helpers['if'].call(depth0, "controller.model.people", {hash:{},inverse:self.noop,fn:self.program(4, program4, data),contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("\n\n  </main>\n\n  <aside ");
  hashContexts = {'class': depth0};
  hashTypes = {'class': "STRING"};
  ...
  hashTypes = {};
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers._triageMustache.call(depth0, "city_name", {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
  data.buffer.push("</h1>\n    <h3>");
  hashTypes = {};
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers._triageMustache.call(depth0, "dates", {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
  data.buffer.push("</h3>\n    <h2 class=\"flag\">");
  hashTypes = {};
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers._triageMustache.call(depth0, "name", {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
  ...
  hashContexts = {'unescaped': depth0};
  hashTypes = {'unescaped': "STRING"};
  stack2 = helpers._triageMustache.call(depth0, "intro", {hash:{
    'unescaped': ("true")
  },contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("\n    </section>\n  </aside>\n</div>\n\n");
  hashTypes = {};
  hashContexts = {};
  stack2 = helpers['if'].call(depth0, "controller.model.spaces", {hash:{},inverse:self.noop,fn:self.program(7, program7, data),contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("\n\n");
  hashTypes = {};
  hashContexts = {};
  stack2 = helpers['if'].call(depth0, "controller.model.tiles", {hash:{},inverse:self.noop,fn:self.program(10, program10, data),contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("\n");
  return buffer;
...
function program2(depth0,data) {
  ...
  data.buffer.push("<div id=\"intro\">\n  <h1 id=\"tagline\">\n    We are a group of developers & designers from Europe, curious about the emerging African tech hubs\n  </h1>\n  <p>\n    We decided to explore the African tech community ourselves and share our impressions on the web and with a video documentary.<br />\n  </p>\n  <p>\n    The journey begins in September 2013\n  </p>\n</div>\n\n<div id=\"teaser row\">\n  <div class=\"col-md-6\">\n    <iframe width=\"560\" height=\"315\" src=\"//www.youtube-nocookie.com/embed/w-QbKIctz60\" frameborder=\"0\" allowfullscreen></iframe>\n  </div>\n  <div class=\"col-md-6\">\n    <p>Since submarine fibre-optic cables connect East Africa to fast, reliable and affordable Internet, the regions tech scene has been leapfrogging: from no net to mobile net in 4 years. We have been working with people from all over the world, but not yet with hackers from Africa. We want to change that. We believe that it takes personal contacts to establish lasting networks. So we decided to just go there.</p>\n    <p>We will meet, connect and share with our peers, bring together European and African hacking culture, and kick off continuous exchange. We will document our road trip on the web and make a movie about it. We want to get everyone in the international tech scene as excited about African hackers as we are.</p>\n  </div>\n</div>\n\n<section class=\"frontpage-grid\">\n  <div class=\"row grid\">\n    ");
  hashTypes = {};
  hashContexts = {};
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push("<main>\n<section>\n  <h1>Sponsoring</h2>\n  <p>\n    AfricaHackTrip is about tech communities. We want to connect people and\n    share knowledge. Doing business is not a primary goal, so the participants\n    will spend their personal time and money. Because it's going to be\n    fun and we believe we can do something good for the tech scene.\n  </p>\n  <p><strong>\n    Partners help us lower the costs, host more and better events for more\n    people and produce a better movie.\n  </strong></p>\n  <p>\n    AfricaHackTrip will organize four hack events in four capital cities\n    reaching hundreds of developers. At the end of our trip we will be present\n    at <a href=\"http://www.demo-africa.com/\">DEMO Africa</a> the continent's\n    largest startup event. We will be filming throughout our journey and\n    release a documentary movie about our experiences when we get back.\n  </p>\n  <p>\n    The events or our movie might be your spot. We'll gladly mention our partners\n    and place their logos in any published material. As a sponsor you will be\n    visible to everyone we meet: startups, developers and other forward-thinking\n    people in a new market with huge growth potential. You can also send people\n    to the events to get involved personally, for example by giving workshops.\n  </p>\n</section>\n<section>\n  <h1>Budget</h1>\n  <p>\n    In total, we'd need about $30,000 to cover all expenses (except our return\n    tickets to Africa and our food &amp; drinks). Your contribution could go\n    towards one of these categories:\n  </p>\n  <ul>\n    <li>\n      Events (venues, catering, prizes)\n    </li>\n    <li>\n      Professional film gear (rental) and high-quality post-production\n    </li>\n    <li>\n      Transport in Africa, visa and accomodation\n    </li>\n  </ul>\n  <p>\n    This is our spread sheets for all the costs:\n    <a href=\"https://docs.google.com/document/d/1LXG2N8S-CB9ltruBT_H9khO7N60AJbUGKaYTs2-6mhs/edit?usp=sharing\">AfricaHackTrip Cost Breakdown</a>\n  </p>\n</section>\n<section>\n  <h1>Get involved!</h1>\n  <p>\n    Sponsorship packages range from $1000 to $5000. Or you can tell us how you\n    would like to partner up with us, and we'll work out a customized package\n    with you.\n  </p>\n  <p>\n    <strong><a href=\"mailto:hello@africahacktrip.org?subject=AfricaHackTrip%20Partnership\">Just get in touch with us</a></strong>,\n    and we'll work something out!\n  </p>\n</section>\n");
...
function program1(depth0,data) {
  ...
  data.buffer.push(">Find out more!</a>\n      ");
  return buffer;
  }

  data.buffer.push("<main>\n  <section id=\"partners\">\n    <h1>Partners</h1>\n\n    <p>\n      <a href=\"http://www.geeksphone.com/\" style=\"background: #FFF; padding: .5em; display: inline-block;\">\n        <img alt=\"\" src=\"/images/supporters/geeksphone.png\" style=\"display: block;\">\n      </a>\n      <a href=\"http://www.github.com/\" style=\"background: #FFF; padding: .5em; display: inline-block;\">\n        <img alt=\"\" src=\"/images/supporters/github.png\" style=\"display: block;\">\n      </a>\n    </p>\n  </section>\n  <section id=\"sponsors\">\n    <h1>Sponsors</h1>\n    <p>\n      We're happy to announce that GitHub is sponsoring all four AfricaHackTrip\n      Events. We &lt;3 you!\n    </p>\n    <p>\n      <strong>Interested in sponsoring AfricaHackTrip?\n      ");
  hashContexts = {'tagName': depth0};
  hashTypes = {'tagName': "STRING"};
  options = {hash:{
    'tagName': ("span")
  },inverse:self.noop,fn:self.program(1, program1, data),contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data};
  stack2 = ((stack1 = helpers.linkTo || depth0.linkTo),stack1 ? stack1.call(depth0, "sponsoring", options) : helperMissing.call(depth0, "linkTo", "sponsoring", options));
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("</strong>\n    </p>\n  </section>\n  <section id=\"thanks\">\n    <h1>Thanks</h1>\n    <p>\n      We want to thank: Nicole and Sylvi for their invaluable advice on how to get\n      around in East Africa and for hooking us up with locals; Martin, David and\n      Marius from <a href=\"http://www.eufrika.org/\">eufrika.org</a>; Geraldine\n      and the team that organised the <a\n        href=\"http://re-publica.de/news/global-innovation-lounge-afrilabs-republica\">Global\n        Innovation Lounge at re:publica 13</a>; the organizers and participants\n      of <a\n        href=\"http://www.bmz.de/de/presse/aktuelleMeldungen/2013/april/130424_pm_77_BMZ-Zukunftsforum-Afrikas-junge-Vordenker-in-Berlin/index.html\">BMZ\n        Future Forum</a>; Johannes in Kampala; Jörn and Katrin over at <a\n        href=\"http://icebauhaus.com/\">ice:bauhaus</a>; and as always, our friends\n      and families. <3\n    </p>\n    <p><strong>Want to support us?</strong> <a\n      href=\"mailto:hello@africahacktrip.org?subject=AfricaHackTrip\">Get in\n      touch!</a></p>\n  </section>\n</main>\n");
  return buffer;
